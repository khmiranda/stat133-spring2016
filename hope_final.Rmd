...
narrowall$boundary <- gsub("state_use_avg", "California Average Water Usage", narrowall$boundary)

narrowall$boundary <- gsub("la_use_avg", "Los Angeles County Average Water Usage", narrowall$boundary)

narrowall$boundary <- gsub("bay_use_avg", "All 9 Bay Area Counties Average Water Usage", narrowall$boundary)
...
```{r}
  ...
  labs(x = "Month", y = "Average Residential Water Usage", title = "Water Usage vs Month") +
  ...
  scale_colour_manual("Scope of Water Usage", values = c("green", "blue","yellow"))
```
