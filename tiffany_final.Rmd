...
```{r}
bins %>% ggplot(aes(x=Month)) + geom_bar() + scale_colour_brewer() + facet_wrap(~ monthly_avg) + theme_economist() + ggtitle("Number of Counties in Each Drought Level") + ylab("# of Counties") + theme(axis.text.x = element_text(angle = 90, hjust = 1))
```
